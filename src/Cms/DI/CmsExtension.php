 ...
 *
 * The module is empty on purpose: pages, menus and blocks arrive later. What
 * is here is the wiring every module has, and it is worth having before
 * there is anything to wire, because it is the part that decides what
