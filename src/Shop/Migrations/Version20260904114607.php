 ...
 * entity of its own.
 */
final class Version20260904114607 extends AbstractMigration
{
    public function getDescription(): string
    {
        return 'Creates the tables the Shop module owns.';
    }

    public function up(Schema $schema): void
    {
        $this->addSql('CREATE TABLE shop_marker (id INT AUTO_INCREMENT NOT NULL, installed_at DATETIME NOT NULL, PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
    }
