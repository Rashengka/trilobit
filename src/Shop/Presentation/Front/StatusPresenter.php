...
/**
 * The page that says the Shop module is part of this build.
 *
...
final class StatusPresenter extends FrontPresenter
{
    public function renderDefault(): void
    {
        ...
        $template->pageTitle = 'Shop';
        $template->moduleName = 'Shop';
        $template->summary = 'The catalogue, the cart and orders live here.';
    }
