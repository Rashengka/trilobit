...
namespace Trilobit\Crm\Migrations;
...
final class Version20260904114606 extends AbstractMigration
{
    ...
    {
        return 'Creates the tables the Crm module owns.';
    }

    public function up(Schema $schema): void
    {
        $this->addSql('CREATE TABLE crm_marker (id INT AUTO_INCREMENT NOT NULL, installed_at DATETIME NOT NULL, PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
    }

    public function down(Schema $schema): void
    {
        $this->addSql('DROP TABLE crm_marker');
    }
}
