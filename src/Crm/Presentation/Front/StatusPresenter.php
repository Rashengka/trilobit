...
/**
 * The page that says the Crm module is part of this build.
 *
...
final class StatusPresenter extends FrontPresenter
{
    public function renderDefault(): void
    {
        ...
        $template->pageTitle = 'Crm';
        $template->moduleName = 'Crm';
        $template->summary = 'Contacts, companies and their activities live here.';
    }
